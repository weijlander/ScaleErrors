...
class ScaleProp(naoqi.ALModule):
	...
	def __init__(self, ip, port, rate):
		...
		self.names = ['RShoulderPitch','RShoulderRoll','RElbowYaw','RElbowRoll','RWristYaw','RHand','LShoulderPitch','LShoulderRoll','LElbowYaw','LElbowRoll','LWristYaw','LHand','RHipYawPitch','RHipPitch','RKneePitch','RAnklePitch','RHipRoll','RAnkleRoll','LHipYawPitch','LHipPitch','LKneePitch','LAnklePitch','LHipRoll','LAnkleRoll','HeadPitch','HeadYaw']
